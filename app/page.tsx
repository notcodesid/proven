...
export default function Home() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#080403] text-white">
      ...
      <section className="relative flex min-h-screen items-center overflow-hidden px-4 pb-16 pt-32 sm:px-8">
        <Image
        ...
        <div className="relative z-10 mx-auto flex w-full max-w-6xl">
          <div className="flex min-w-0 max-w-[780px] flex-col items-start text-left">
